...
description: "Use this skill whenever Blair asks for a cover letter, application letter, letter of interest, or asks to improve/analyze a cover letter for a job application. This skill governs cover-letter strategy, structure, evidence selection, differentiation, sentence-level anti-slop quality control, and final submission quality. It works alongside JD_pipeline_SKILL.md and Blair_Voice_SKILL.md. The Career Journey remains the factual source of truth; JD_pipeline governs job-fit/ATS/evidence logic; Blair Voice governs tone, anti-AI style, and sentence construction; this skill governs how to turn those ingredients into a cover letter that makes the hiring team want to talk to Blair."
---

# Blair Cover Letter Writer

This skill exists to create cover letters that do more than prove Blair is qualified.
...
A strong Blair cover letter should feel like a smart operator has already started thinking about the company’s problem before the interview.
...
1. **Career Journey source of truth** — all factual career claims, metrics, roles, tools, accomplishments, and examples must be supported by the current highest-version `blair_boylan_career_journey*.json`.
...
5. **Blair_Voice_SKILL.md** — controls Blair’s sentence construction, tone, reasoning style, anti-AI editing, and mechanical style constraints.
...
- **Pipeline handoff:** Stage 9 of `JD_pipeline_SKILL.md` after a tailored resume has been delivered and Blair says he needs a cover letter.
- **Direct cover-letter request:** Blair asks for a cover letter, application letter, or letter of interest before or outside the resume workflow. Use the current application context and highest-version Career Journey directly. Do not force Blair through Stages 1–8 again if the company, exact role, and JD are already available.
- **Cover-letter critique:** Blair asks to analyze, score, improve, rewrite, or make an existing cover letter stronger. Score the existing letter with this skill's rubric, identify the highest-leverage weaknesses, then rewrite only when requested or when the request clearly asks for improvement.
- **Formal document output:** If Blair asks for a `.docx` or PDF cover letter, use the same approved prose and preserve the resume's contact/header conventions, including the clickable `https://blairboylan.com/` URL.
...
- **Career Journey:** what Blair has actually done.
...
- **Blair Voice:** how Blair would naturally express that argument and how to remove AI-style writing patterns.
...
2. **How does Blair think about the problem in a way that is useful or distinctive?**
...
# 3. What makes a Blair cover letter stand out

The strongest Blair cover letters do four things well:

## A. Show that Blair understands the business beneath the job description
...
For example, rather than saying Blair is strong cross-functionally, describe how a customer signal can become a product decision, integration priority, GTM change, partnership opportunity, or company-level bet, and how someone has to follow that signal until it becomes a decision, owner, and execution.
...
- Blair’s role in it
- what Blair actually changed or built
...
## D. Make Blair’s unconventional profile an advantage without defending it
...
- “Although I have already been a CSO...”
...
Instead, make Blair’s motivation obvious through what he is drawn to:
...
Let the reader infer that Blair is choosing the work intentionally.
...
- a tension Blair has personally encountered that directly maps to the company's problem
...
3. connection to Blair's actual point of view or experience
4. curiosity / reason to continue reading
5. naturalness in Blair's voice
...
- The opening begins by announcing Blair's interest rather than demonstrating why the work is interesting.
...
Do not write a "hook." Begin with the most interesting specific observation Blair has about the work this company is doing, the customer problem it faces, or the unusual responsibility this role owns.

The reader should enter the argument immediately. Do **not** begin by summarizing Blair’s background, announcing that he is applying, or announcing that he finds the company interesting.
...
1. A specific operating or technical tension Blair recognizes from direct experience.
...
By the end of the paragraph, the reader should understand why this particular problem is compelling to Blair without seeing the phrases “I am interested,” “I am excited,” or “I was drawn to.”
...
Use the strongest Career Journey evidence that proves Blair has operated inside a comparable problem.
...
> As Nymbl grew, I worked directly with the CEO to build the operating structure connecting company priorities to initiatives, owners, metrics, and execution, while designing the GTM motion that supported growth from $1.5M to $9.2M in annual services revenue.
...
- explains what Blair wants to be close to in this stage of the company
- names the messy, cross-functional work he wants to own
...
- a product mechanism relevant to Blair’s point of view
...
- use the same name/contact header style as Blair’s resume
- use `https://blairboylan.com/` as a real clickable hyperlink in the header unless Blair explicitly requests otherwise
...
- otherwise use a natural team salutation such as `Dear Hostie team,`
...
- generic enthusiasm
- long lists of functions Blair has touched
...
Do not use introductory constructions whose primary function is to announce interest or establish that Blair has read the job description.
...
# 10. Blair-specific voice requirements

Apply Blair_Voice_SKILL.md in Blair Personal Voice.
...
A successful letter should sound like Blair has thought about the company, not like an AI has optimized a cover letter.
...
> We grew services revenue from $1.5M to $9.2M, proving that the organization was ready for a new era of scalable execution.

The metric is supportable. The tail is not. Keep the metric and state the actual mechanism Blair changed.
...
- paraphrases of the job description before Blair's actual observation
...
- connect Blair's evidence to the hiring problem without overstating causality
...
Before the 10-point rubric is applied, perform a sentence-by-sentence pass for the four Blair Voice slop categories:
...
When Blair asks to **analyze or improve an existing cover letter**, score the supplied draft first using this same rubric. Give the overall score, identify the 2–4 changes most likely to improve interview interest, and distinguish strategic problems (weak hook, generic point of view, poor proof selection) from sentence-level voice problems. If he asks for a rewrite, revise toward 8.5+ rather than merely polishing the existing structure.
...
**1.5:** Blair explains the business/role through a useful, non-obvious operating mechanism that makes the reader think differently.
...
**1.5:** The reader can clearly understand why Blair wants this exact work at this exact stage without Blair needing to defend his background.
...
**1.0:** Sounds distinctly like Blair; low AI-suspicion profile; natural sentence rhythm; no canned cover-letter or professional-writing language; no unresolved slogan-like, unsupported, jargon-heavy, or inflated sentences.
...
- Would Blair himself keep reading?
- Does this sentence contain an actual idea, or is it setting up an idea?
- Would a hiring manager learn anything from it?
- Is the sentence true because Blair has observed something, or merely polished because he is applying for a job?
...
- Does the letter explain how Blair thinks, not just what he has done?
...
> I am excited to apply for the Chief of Staff role at Hostie. With more than 10 years of experience in strategy and operations, I believe I am well qualified to contribute to your growing team.

Why it fails:

- resumes Blair before discussing Hostie
...
> I realize I have already held a Chief Strategy Officer title, but I am still very interested in this Chief of Staff opportunity.

Why it fails:

- introduces overqualification as a problem
- forces the reader to evaluate title regression
- makes Blair sound defensive
...
A successful Blair cover letter should leave the reader with three reactions:

1. **He understands the problem we are actually solving.**
2. **He has operated inside something similar and can prove it.**
3. **I want to hear how he thinks about this in a conversation.**

If the letter only produces “he seems qualified,” it is not finished.
